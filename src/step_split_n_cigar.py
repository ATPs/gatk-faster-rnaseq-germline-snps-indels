...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run GATK SplitNCigarReads.")
    ...
    run_command(gatk_cmd(args.java_mem, "SplitNCigarReads", "-R", args.ref, "-I", args.input_bam, "-O", args.output_bam))
